// Couleurs utilisées pour les projets, le parcours et le quiz
export const PALETTE = ["#2542F5", "#B33A1D", "#0E8F6E", "#7C3AED", "#D4A017"];

// Version plus foncée de la palette, pour le texte sur fond clair (meilleur contraste)
...
// Défilement vers une section au clic sur un lien de nav
const NAV_HEIGHT = 56; // hauteur de la barre de nav
